...
"Time-AccelBody-Jerk-Y-Std", "Time-AccelBody-Jerk-Z-Std", "Time-GyroBody-X-mean", "Time-GyroBody-Y-Mean", "Time-GyroBody-Z-Mean",
"Time-GyroBody-X-Std", "Time-GyroBody-Y-Std", "Time-GyroBody-Z-Std", "Time-GyroBody-Jerk-X-Mean", "Time-GyroBody-Jerk-Y-Mean",
"Time-GyroBody-Jerk-Z-Mean", "Time-GyroBody-Jerk-X-Std", "Time-GyroBody-Jerk-Y-Std", "Time-GyroBody-Jerk-Z-Std", 
"Time-AccelBody-Mag-Mean", "Time-AccelBody-Mag-Std", "Time-AccelGravity-Mag-Mean", "Time-AccelGravity-Mag-Std",
"Time-AccelBody-Jerk-Mag-Mean", "Time-AccelBody-Jerk-Mag-Std", "Time-GyroBody-Mag-Mean", "Time-GyroBody-Mag-Std",
"Time-GyroBody-Jerk-Mag-Mean", "Time-GyroBody-Jerk-Mag-Std", "Freq-AccelBody-X-Mean", "Freq-AccelBody-Y-Mean", 
"Freq-AccelBody-Z-Mean", "Freq-AccelBody-X-Std", "Freq-AccelBody-Y-Std", "Freq-AccelBody-Z-Std", "Freq-AccelBody-meanFreq-X",
"Freq-AccelBody-meanFreq-Y", "Freq-AccelBody-meanFreq-Z", "Freq-AccelBody-Jerk-X-Mean", "Freq-AccelBody-Jerk-Y-Mean",
"Freq-AccelBody-Jerk-Z-Mean", "Freq-AccelBody-Jerk-X-Std", "Freq-AccelBody-Jerk-Y-Std", "Freq-AccelBody-Jerk-Z-Std",
"Freq-AccelBody-Jerk-meanFreq-X", "Freq-AccelBody-Jerk-meanFreq-Y", "Freq-AccelBody-Jerk-meanFreq-Z", "Freq-GyroBody-X-Mean",
"Freq-GyroBody-Y-Mean", "Freq-GyroBody-Z-Mean", "Freq-GyroBody-X-Std", "Freq-GyroBody-Y-Std", "Freq-GyroBody-Z-Std",
"Freq-GyroBody-meanFreq-X", "Freq-GyroBody-meanFreq-Y", "Freq-GyroBody-meanFreq-Z", "Freq-AccelBody-Mag-Mean", 
